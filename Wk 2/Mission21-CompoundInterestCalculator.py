...
def calculate_final_amount(p,r,n,t):
    ...
    amount = p*(1+r/n)**(n*t)#Formula to calculate final amount
    print() #Modify to display the calculated final amount value

    return amount #Do not remove this line

#Do not remove the next line
calculate_final_amount(p,r,n,t)
print(calculate_final_amount(10000,0.08,12,5))
print(calculate_final_amount(10000,0.08,12,1))
